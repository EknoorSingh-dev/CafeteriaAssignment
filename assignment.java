public class assignmentcafteria {
    ...
    public static void main(String[] args) {
        ...
        assignmentcafteria item1 = new assignmentcafteria();
        assignmentcafteria item2 = new assignmentcafteria();
        assignmentcafteria item3 = new assignmentcafteria();

        item1.addFoodItem(101, "Veg Sandwich", 80);
        item2.addFoodItem(102, "Cold Coffee", 120);
        item3.addFoodItem(103, "Paneer Wrap", 150);

        assignmentcafteria.displayCafeteriaDetails();

        item1.displayItemDetails();
        item2.displayItemDetails();
        item3.displayItemDetails();

        assignmentcafteria.changeServiceCharge(15);
